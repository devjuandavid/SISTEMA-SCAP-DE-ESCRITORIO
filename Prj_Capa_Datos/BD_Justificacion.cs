   ...
   public  class BD_Justificacion : Cls_Conexion 
    {
        ...
        public DataTable BD_BuscarJustificacion_porValor(string xdato)
        {
            ...
            try
            {
                ...
                SqlDataAdapter da = new SqlDataAdapter("Sp_Cargar_Justificacion_xDoc", cn);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
            ...
            catch (Exception ex)
            {
                ...
                cn.Close();
                cn = null;
                MessageBox.Show("Algo malo paso" + ex.Message, "Adevertencia de Seguridad", MessageBoxButtons.OK, MessageBoxIcon.Error);

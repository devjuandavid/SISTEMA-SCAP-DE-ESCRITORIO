   ...
   public  class RN_Personal
    {
        ...
        public bool RN_Verificar_DocPersonal(string Doc)
        {
            BD_Personal obj = new BD_Personal();
            return obj.BD_Verificar_DocPersonal(Doc);
        }



        public void RN_Eliminar_Personal(string DOC)
        {
            BD_Personal obj = new BD_Personal();
            obj.BD_Eliminar_Personal(DOC);
        }
    }
}
